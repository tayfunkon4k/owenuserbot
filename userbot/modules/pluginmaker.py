...
c_ = c("pluginmaker")
c_.add_command("pmake", "<pluginin_komutu> <plugin_hızı> <edit/alt/foto/muzik> ", "@SefillerUserBot Sizin İçin Bir plugin Oluşturur...")
c_.add_info(' Thx to @TRCUMHURBASKANI').add()
c_.add()
